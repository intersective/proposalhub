...
import { User, getUserByEmail, updateUserCredentialCounter, getUserChallenge } from '@/app/lib/userDatabase';
...
export const POST = async (req: NextRequest) => {
  ...
  try {
    ...
    const verification = await verifyAuthenticationResponse({
      ...
      authenticator: {
        credentialPublicKey: new Uint8Array(dbAuthenticator.credentialPublicKey),
        credentialID: new Uint8Array(Buffer.from(dbAuthenticator.credentialID, 'base64')),
