  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push(`/manage/organizations/${organization.id}`);
      }
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">New Organization</h1>
          </div>
                      ...
                      <div>
                        ...
                        <div className="flex space-x-2">
                          <input
                            ...
                            placeholder="Search for organization logo..."
